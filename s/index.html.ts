	...
	return easypage({
		...
		body: html`
			<game-app>
				...
				<p>We’re deep in development because, uh, we built a time machine. Opened a portal to an alternate 1999, stole the best roguelike ever made in the multiverse, and now we’re porting it to the modern web.</p>
