...
import {generateFloorplan} from "./layouting/generate-floorplan.js"
import {eliminateKissingCorners} from "./layouting/eliminate-kissing-corners.js"
import {DungeonSpace, GlobalCellVec2, GlobalSectorVec2, GlobalTileVec2} from "./layouting/space.js"
...
export class DungeonLayout {
	...
	constructor(public options: DungeonOptions) {
		const space = this.space = new DungeonSpace(options)
		const floorplan = generateFloorplan(space)
